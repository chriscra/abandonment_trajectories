...
# gg_quadrant_endpoints <-
  ...
  geom_point(alpha = 0.6, 
    ...
    geom_point(data = quadrant_endpoints %>%
  ...
  geom_textpath(mapping = aes(x = area_2017_as_prop_total_crop,
                              y = mean, label = site), 
                # size = 3, 
                # hjust = -1, 
                vjust = 0.7,
                inherit.aes = F, text_only = T) +
...
# save 
ggsave(plot = gg_quadrant_endpoints,
       filename = paste0(p_plots, run_label, "/quadrant_endpoints", run_label, ".pdf"), 
       # width = 9, height = 7,
       width = 7, height = 6,
       # width = 3.42, height = 3.4, 
       units = "in")
...
gg_quadrant_endpoints_mean <- 
  ...
  geom_vline(xintercept = mean(quad_end_tmp$area_2017_as_prop_total_crop), 
             linetype="dashed", #alpha = 0.4, 
             colour = "red") +
  geom_hline(yintercept = mean(quad_end_tmp$mean_hl), 
             linetype="dashed",# alpha = 0.4,
             colour = "red") +
  geom_point(alpha = 0.6) + 
  geom_text_repel(
