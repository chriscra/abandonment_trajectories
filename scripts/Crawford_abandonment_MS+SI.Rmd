...
`r recult_duration_stats$duration_max_site`, had a mean recultivation length of `r recult_duration_stats$duration_max` years, whereas recultivation at the other sites lasted between `r recult_duration_stats$duration_min` and `r recult_duration_stats$duration_2nd_highest` years; see Fig. \@ref(fig:mean-recult-duration)).
...
*Maybe move this to the methods?*
