...
rmarkdown::render("/Users/christophercrawford/work/projects/abandonment_trajectories/scripts/Crawford_abandonment_MS+SI.Rmd",
                  output_file = 
...
<!-- Here today, grain tomorrow: Rural land abandonment provides few benefits for biodiversity and climate -->

<!-- (Too long) Despite potential, cropland abandonment is often too ephemeral to provide carbon or biodiversity benefits during rural transitions -->

<!-- “Cropland abandonment is often ephemeral, limiting the potential for rural transitions to provide carbon or biodiversity benefits” -->

<!-- “Without incentives for regeneration, cropland abandonment rarely lasts long enough to provide biodiversity or carbon benefits” (which I currently use as our “teaser”) -->

<!-- “Rural land abandonment provides few benefits for biodiversity and climate.” -->
...
However, we also found that many of these abandoned croplands were recultivated: `r recult_stats$mean_thr_5`% of abandoned area had been recultivated as of 2017, on average, across sites (SD = `r recult_stats$sd_thr_5`%; Fig. \@ref(fig:recult-by-threshold)).
...
Accordingly, the mean duration of abandonment across all sites was short: `r abn_duration_stats$mean_of_means_duration` years (SD = `r abn_duration_stats$sd_of_mean_duration`), ranging from `r abn_duration_stats$duration_min` (`r abn_duration_stats$duration_min_site`, Russia/Uralsk, Kazakhstan) to `r abn_duration_stats$duration_max` years (`r abn_duration_stats$duration_max_site`; Fig. \@ref(fig:mean-abn-duration)).
