...
# 2      2 projected     m integer         5  ✓
# 3      3 projected     m integer         5  ✓
# 4      4 projected     m integer         5  ✓
# 5      5 projected     m integer         5  ✓
# 6      6 projected     m integer         5  ✓
# 7      7 projected     m integer         5  ✓
# 8      8 projected     m integer         5  ✓
# 9      9 projected     m integer         5  ✓
# 10    10 projected     m integer         5  ✓
# 11    11 projected     m integer         5  ✓
# 12    12 projected     m integer         5  ✓
# 13    13 projected     m integer         5  ✓
# 14    14 projected     m integer         5  ✓
# 15    15 projected     m integer         5  ✓
# 16    16 projected     m integer         5  ✓
# 17    17 projected     m integer         5  ✓
# 18    18 projected     m integer         5  ✓
# 19    19 projected     m integer         5  ✓
# 20    20 projected     m integer         5  ✓
# 21    21 projected     m integer         5  ✓
# 22    22 projected     m integer         5  ✓
# 23    23 projected     m integer         5  ✓
# 24    24 projected     m integer         5  ✓
# 25    25 projected     m integer         5  ✓
# 26    26 projected     m integer         5  ✓
# 27    27 projected     m integer         5  ✓
# 28    28 projected     m integer         5  ✓
# 29    29 projected     m integer         5  ✓
# 30    30 projected     m integer         5  ✓
# 31    31 projected     m integer         5  ✓

list_lsm()

# Explore metrics
list_lsm(level = "landscape", type = "aggregation metric", simplify = FALSE)
...
ls_metrics <- btr %>%
  calculate_lsm(
    ...
    what = 
      grep("circle", 
           list_lsm(level = "landscape", simplify = TRUE), 
