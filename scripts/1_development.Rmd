...
```{r filtering-workflow-adroit-script}
...
fwrite(dt, file = "/Users/christophercrawford/Google Drive/_Projects/abandonment_trajectories/data_derived/age_s.csv")
toc()
...
fwrite(length, file = "/Users/christophercrawford/Google Drive/_Projects/abandonment_trajectories/data_derived/length_s.csv")

# explore some stats:
length[, .N, by = length]
length[, mean(length)] # mean time abandoned if using no threshold
length[length >= 3, mean(length)] # mean time abandoned, if using 3 year abandonment definition threshold
