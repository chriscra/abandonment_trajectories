...
par(mfrow = c(3,3))
plot(b87_r, main = "Belarus 1987", breaks = plot_breaks, col = plot_cols)
plot(b1, breaks = plot_breaks, col = plot_cols)
plot(b2, breaks = plot_breaks, col = plot_cols)
plot(b3, breaks = plot_breaks, col = plot_cols)
plot(b4, breaks = plot_breaks, col = plot_cols)
plot(b5, breaks = plot_breaks, col = plot_cols)
plot(b6, breaks = plot_breaks, col = plot_cols)
...
plot(b_merge, breaks = plot_breaks, col = plot_cols)
check <- b87_r - b_merge
plot(check)
