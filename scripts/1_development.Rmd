...
b87_r <- raster("/Users/christophercrawford/Google_Drive/_Projects/data/Abandonment/belarus_1987.tif")
b88_r <- raster("/Users/christophercrawford/Google_Drive/_Projects/data/Abandonment/belarus_1988.tif")
...
site_list <- c("shaanxi", "belarus", 
               "chongqing", "goias", "mato_grosso", 
               "nebraska", "wisconsin", "volgograd",
               "orenburg", "bosnia_herzegovina", "iraq") # list of all sites
...
test <- brick(paste0("/Users/christophercrawford/Google_Drive/_Projects/data/Abandonment/Final_maps/", map_files[2]))
test
cellStats(test, "mean")
cellStats(test, )
freq(test)
...
```{r load-GEE}
p_eefull <- "/Users/christophercrawford/Google_Drive/_Projects/data/Abandonment/eefull/"
...
tic("load raster")
r <- brick("/Users/christophercrawford/Google_Drive/_Projects/data/Abandonment/belarus_small.tif")
...
fwrite(dt, file = "/Users/christophercrawford/Google_Drive/_Projects/abandonment_trajectories/data_derived/shaanxi_age.csv")
toc()
...
fwrite(length, file = "/Users/christophercrawford/Google_Drive/_Projects/abandonment_trajectories/data_derived/shaanxi_length.csv")
...
# As of 2021.1.19, the most up to date version of this is at:
# /Users/christophercrawford/Google_Drive/Stats_Code_Methods/R/data.table_openmp_threads.R
...
# load
library(data.table)
getDTthreads(verbose = TRUE) # using 4 threads. Working as of 12.5.2020 (updated to llvm version 11).

# See the following:
# https://github.com/Rdatatable/data.table/wiki/Installation
# ~/.R/Makevars

# also see note titled: "Installing OpenMP" in Evernote notebook "C2. Trajectories of Abandonment & Biodiversity"
```
...
s_dt[, .(freq = .N), by = y1987]
names(s_dt)
length(s_dt)

col_names <- grep("x$|y$", names(s_dt), value = TRUE, invert = TRUE)

col_names[2]
i <- 2

# check the distribution of each land cover class

s_dt[, .N, by = y1988][order(y1988)]

for (i in seq(col_names)) {
    temp_dt <- s_dt[, .N, by = c(col_names[i])][order(get(col_names[i]))]
