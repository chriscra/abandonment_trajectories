...
# -------------------------------
# 3. Then, filter out the first period of noncrop prior to abandonment
# -------------------------------
...
lengths <- extract_lengths(dt_diff)

length(dt)
length(dt_diff)

dt[V14 > 0, V14] # periods from the last column
