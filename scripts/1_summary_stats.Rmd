...
2. Calculating **summary statistics** for the manuscript, particularly the mean duration of abandonment at each site.
  ...
  b. Plotting the mean observed abandonment duration along with the underlying distribution of all abandonment periods. This resulted in the main text Figure 4 (and a corresponding figure in the SI for max lengths, for potential abandonment without recultivation, and recultivation periods themselves).
...
3. Calculating the **area abandoned**, resulting in *area_summary_df*. This also involved:
  ...
  c. Calculating the mean proportion of abandoned land that is recultivated at each site (allowing for multiple instances of abandonment for pixel), and how this changes based on the chosen definition of abandonment (1, 3, 5, 7, or 10 years). [Note that the script "cluster/6_lc_of_abn.R" calculates the proportion of abandonment (as of 2017) that is classified as woody vegetation vs. grassy (herbaceous) vegetation.]
...
## Final distribution figures (*manual*)

The observed abandonment distribution figure was initially Figure 2 in the draft manuscript, which is why these figures are collectively referred to as Fig2 variations.
...
```{r overlaying-obs-pot-distributions}
