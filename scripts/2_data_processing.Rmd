...
blips_count <- cc_count_blips(dt, start_year = 1987)
...
(five_yr_count/nrow(dt))*100

# count of the first 0 position
...
# -------------------------------------------------------------------------- #
# New temporal filter (Februar 18th, 2021)
# -------------------------------------------------------------------------- #
