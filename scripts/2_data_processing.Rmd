...
blips_long <- pivot_longer(s_blips, cols = c(2:4), names_to = "threshold", values_to = "count")

ggplot(data = blips_long, mapping = aes(x = year, y = count, 
                                        group = threshold, fill = threshold)) + 
