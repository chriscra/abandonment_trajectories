...
tic()
count_edge_df <- cc_temporal_filter_count_edge_cases(dt = dt)
toc()

tic()
cc_temporal_filter_edge_cases(dt, replacement_value = -7)
toc()
dt[]
...
tic()
count_edge_df <- cc_temporal_filter_count_edge_cases(dt = s_dt)
toc()

tic()
cc_temporal_filter_edge_cases(dt = s_dt, replacement_value = -7)
toc()
s_dt[]
```
