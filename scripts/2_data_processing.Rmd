...
# pick up here, by combining the temporal count filters into a single function.
# the edge temporal filter can remain separate, just so that it's a bit easier to see what's going on in the meta function.
