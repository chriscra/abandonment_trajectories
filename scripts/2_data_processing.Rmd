  ...
  lapply(site_df$site, function(x) {
    ...
    cat(fill = TRUE, 
        ...
        temporal_filter_counts_l$edge_nrow_affected %>%
               mutate(nrow = value/percent_affected) %>% 
               .$nrow %>% unique())
    
    percent_affected_df <- 
      bind_rows(temporal_filter_counts_l$nrow_affected,
                temporal_filter_counts_l$edge_nrow_affected %>% 
                  filter(edge == "start") %>% 
      ...
      as_tibble() %>% mutate(filter = recode(filter, 
                                             "start" = "starting_edge"))
...
site_df_w_size <- read_csv(file = "/Users/christophercrawford/Google Drive/_Projects/abandonment_trajectories/data_derived/site_df_w_size.csv") 
...
# s_dt_age_b1_r <- brick("/Users/christophercrawford/Google Drive/_Projects/abandonment_trajectories/data_derived/age_rasters/shaanxi_age_b1.tif")
...
names(s_dt) <- gsub(pattern = "andcover", replacement = "y", names(s_dt))
# /Users/christophercrawford/Google Drive/_Projects/abandonment_trajectories/data_derived/age_rasters/shaanxi_age_b1.tif
