...
site_description <- c(
  ...
  "Orenburg, Russia/Oral, Kazakhstan",
...
area_tmp2 <- cc_calc_area_per_lc_abn_update(land_cover_dt = lc_dt, 
                                    abn_age_dt = age_dt, 
...
ref_area_df <- read_csv("/Users/christophercrawford/Google_Drive/_Projects/abandonment_trajectories/data_derived/_2021_03_13/shaanxi_result_area_2021_03_13.csv")

ref_area_df
area_df
area_tmp

identical(area_df, area_tmp)
identical(area_tmp, area_tmp2)

ggplot(data = area_tmp2 %>% filter(lc != "Abandoned (>1)")
    ) +
    theme_classic() +
    # theme(axis.text.x = element_text(angle = 320, vjust = 1, hjust = 0)) +
    labs(y = expression("Area  (10"^{6}*" ha)") , 
    ...
    scale_color_manual(values = plot_cols) #+   facet_wrap(vars(site))

```

```{r update-cc_calc_abn_area}
