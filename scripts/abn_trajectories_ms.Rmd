...
# Abstract
*Must be <250 words (currently 237)*
...
Coupled with environmental changes and other factors that render some agricultural lands economically inviable, this rural outmigration has contributed to a growing global trend of agricultural abandonment [@Prishchepov2021].
...
(Add citations, e.g. @Chazdon2020, @Naess2021, @Xie2019)

However, understanding agricultural abandonment and its potential impacts on biodiversity requires not only detailed information on where and how abandonment is taking place, but critically, what happens to croplands after they are abandoned.
Most estimates of abandonment are inferred from aggregated estimates of regional cultivation (e.g. from FAO data on cultivated area; [@Isbell2019; @Munroe2013]), derived from estimates of the gross area abandoned in a given year [@Lark2015], or calculated as the difference in cultivated area between two distinct points in time [@Naess2021].
However, these approaches lack spatial and temporal detail on the trajectories taken by individual pieces of land, which is critical for understanding the environmental implications of abandonment [@Yin2020].
...
@Yin2020 established several methodological advances, including improvement in the mapping of 1) the timing of initial abandonment (year first abandoned), and 2) the abandonment rate (amount of abandoned land in a given year divided by the amount of agricultural land in either a) the previous year or b) the beginning of the time series).
However, @Yin2020 did not assess the persistence of abandonment (how long abandoned lands stay abandoned for), frequency and patterns of recultivation, spatial predictors of abandonment persistence and recultivation, patterns of fragmentation in the resulting landscape, nor the implications of these for biodiversity. (These last two are likely for a second paper.)

Previous analyses have explored the age and persistence of secondary forests in Costa Rica [@Reid2018] and the Amazon [@Nunes2020, @Smith2020] by identifying regeneration directly through the signal of woody regrowth in satellite imagery.
Others have estimated the age of regenerating habitats by relying on satellite-derived estimates of biomass and the relationship between biomass, climate, and forest age based on forest chronosequences [@Chazdon2016a].

While well suited to analyses of forest regrowth, this approach risks missing abandonment at earlier stages, or which does not transition into woody vegetation, particularly in landscapes that include non-forest habitats [@Yin2020].
...
These studies highlight the perils of short-lived secondary forests by providing estimates of the average persistence times of secondary forests, yet there continues to be relatively limited knowledge on the persistence and turnover of abandoned croplands.
...
@Schwartz2020 study a 14 year time series, showing that reversals (i.e. reclearing) of reforestation were 10 times more common than reforestation that persisted (11% of pixels showed reforestation followed by reclearing, compared to only 1.1% of pixels that showed persistent reforestation.

@Steininger2004 used fallow periods of 4, 6, and 8 years (drawn from @Chazdon2016a).


## timing of abandonment papers
...
# Insert context based on papers by @Estel2015 (recultivation, timing), @Estel2018, @Dara2018 (timing, recultivation, northern Kazakhstan), @Alcantara2013, @Lesiv2018 (methods of mapping), @Smaliychuk2016 (recultivation, predictors, Ukraine), @Prishchepov2013 (predictors), @Baumann2011 (), @Pazur2020 (Slovakia), @Levers2018a (predictors), @PerpinaCastillo2021 (predictors, model), @Meyfroidt2016 (drivers, tradeoffs, recultivation, timing, Russia/Ukraine/Kazakhstan, but bd benefits limited to distance to PAs), @Crouzeilles2020 (Atlantic Forest, predictors)
```
...
Most sites showed a negative trend in the time required for recultivation, indicating that abandoned croplands were being recultivated more quickly over time (Figure \@ref(fig:decay-rate-of-change)).
A simple linear regression on the time required for half of each cohort of abandoned cropland to be recultivated revealed that just over half of our sites showed rates of change that were negative and significantly different from zero: Bosnia & Herzegovina, Volgograd, Wisconsin, Nebraska, Orenburg, and Iraq (Figure \@ref(fig:decay-rate-of-change)).
...
Mention the sensitivity analysis we conducted on thresholds of abandonment - definitions of abandonment and the variation we see
