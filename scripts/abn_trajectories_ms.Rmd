---
title: "Rural cropland abandonment is too ephemeral to benefit climate stabilization or biodiversity conservation"
author:
...
We address three questions: (1) How long does abandoned cropland stay abandoned on average, and how does this vary geographically?
(2) How quickly is abandoned cropland recultivated, and do recultivation (or "decay") rates vary through time?
(3) If abandonment and recultivation continue at current rates, what will ultimately be the mean age of abandoned croplands?

By making use of more accurate and finer resolution abandonment maps for a longer period and a broader set of sites than previous studies, we provide the most detailed analysis to date of the persistence of cropland abandonment.
...
Given that some abandonment periods are inherently limited by the length of our time series (and that cropland may remain abandoned beyond the three decades covered by our data), tracking recultivation rates for each year provides a more accurate understanding of persistence.
...
By tracking cohorts of abandoned croplands based on the year of abandonment, we developed a much more detailed and nuanced picture of abandonment persistence than have previous studies.
...
Furthermore, estimates of abandonment based on short time series or just two points in time (e.g., 83 Mha estimated in ref.[@Naess2021]) likely overestimate the amount of persistent abandonment, due to both a failure to exclude short-term fallow periods, and, as our analysis shows, high rates of recultivation.
...
This corresponds to site-level estimates that ranged from a `r abs(abn_2yr_stats$low_percent)`% smaller (`r abn_2yr_stats$low_p_site`) to a `r abn_2yr_stats$high_percent`% larger (Mato Grosso) area abandoned than the area identified using the full time series.
