...
We chose to apply this brief recultivation threshold because even just a year or two of cultivation can serve to entirely reset vegetation succession on that piece of land [*needs citation*].
...
These edge patterns were very uncommon, however, affecting fewer than X% of pixels at each site. *^[Needs updating]*
