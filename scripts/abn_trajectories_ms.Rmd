...
rmarkdown::render("scripts/abn_trajectories_ms.Rmd",
                  output_file = paste0(p_proj, "writing/previews/", "abn_duration_draft", format(Sys.Date(), ("_%Y_%m_%d")), ".pdf"),
...
### Changing decay rates through time
...
(ref:caption-decay-rate-of-change) The rate of change of decay rates (measured by the time required for each cohort to decline by half) at each site over the course of the time series. The four quadrants on the left show the time required for a cohort of abandoned land to decline by half, in terms of years per year. Solid lines show simple linear regressions, the slopes of which are shown at right. Error bars represent the 95% confidence intervals on slope estimates.
