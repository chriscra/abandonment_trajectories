...
Current title: Impermanence of cropland abandonment limits potential for environmental benefits
...
<!-- [*Note: these summary statistics are calculated based on the mean abandonment duration at each site, and are therefore the mean of means, and the standard deviation of means. The mean standard deviation is now reported in the SI Section @ref(results-si).*] --> At most sites, we project that \>50% of abandoned croplands will be recultivated within 25 years, and sites in Eastern Europe, Russia, and the US show accelerating rates of recultivation.
...
To conservationists, these abandoned croplands represent a potentially large opportunity for biodiversity recovery as native vegetation regenerates [@Chazdon2020; @Xie2019; @Navarro2012].[^*I had originally included this as a way to orient readers to our emphasis on the biodiversity conservation perspective. Do you mind sharing a bit more about your recommendation to remove it? Is it the length, or that you think it better to be more neutral at this stage?*]
...
Annual land-cover time series are becoming more common, but are typically limited to a few years (e.g., 2-12 years [@Alcantara2013; @Estel2015; @Lark2015]), and most analyses are restricted to a single region [@Dara2018].
...
In fact, only `r area_abn_stats$total_area_abn_Mha_2017_all_sites` Mha of abandoned croplands remained abandoned as of 2017 across our sites (Figure \@ref(fig:maps-abn-duration)).
...
Furthermore, estimates of abandonment based on short time series or two points in time (e.g., 83 Mha estimated by Næss et al. [@Naess2021]) likely overestimate the amount of persistent abandonment, due to both a failure to exclude short-term fallow periods, and, as our analysis shows, high rates of recultivation.
...
Recultivation may dramatically limit the scope for abandoned croplands to play a major role in carbon sequestration or the recovery of biodiversity.
...
On average, secondary grasslands distributed around the world that are between 1-251 years old contain only 53-76% of the plant species richness of undisturbed grasslands (sometimes called ancient or "old-growth" grasslands [@Nerlekar2020]).
...
Together with our five-year abandonment threshold, these temporal filters address very short-term misclassifications that might otherwise appear to be like recultivation.
...
Code to replicate these analyses is available on GitHub at <https://github.com/chriscra/abandonment_trajectories>, and is archived at [Zenodo (TBD)](https://doi.org/).
