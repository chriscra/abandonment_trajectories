...
Populations are in flux around the world, as people seek new economic opportunities in cities and flee changing environments and conflicts [@Sanderson2018; @McLeman2011; @Yin2019].
Coupled with environmental changes and other factors that render some agricultural lands economically inviable, this rural outmigration has contributed to a growing global trend of agricultural abandonment [@ReyBenayas2007; @Li2017; @Prishchepov2021].
In a world with increasing competition for land, abandoned agricultural lands are highly sought after for diverse goals such as increased cultivation [@Prishchepov2021a; @Meyfroidt2016], biofuel production [@Campbell2008; @Naess2021], and carbon sequestration [@Griscom2017; @Chazdon2016a; @Chapman2020; @Yang2020]; to conservation scientists, this land represents a potentially large source of new habitat for wildlife as vegetation regenerates [@Chazdon2020; @Xie2019; @Navarro2012].

However, understanding agricultural abandonment and its potential impacts on biodiversity and carbon sequestration requires not only detailed information on where and when abandonment is taking place, but critically, what happens to croplands and pastures after they are abandoned.
In order for abandoned lands to yield environmental benefits, they must stay abandoned long enough for appreciable gains to be made in both biomass and the species that make up intact ecological communities, which can take decades or longer to approach the levels of intact reference ecosystems [@Cook-Patton2020; @Nerlekar2020; @Rozendaal2019; @Acevedo-Charry2019; @Gilroy2014; @Isbell2019; @Poorter2016].
As a result, information on the long-term persistence and outcomes of abandoned lands is critical for understanding the potential for these areas to help mitigate the ongoing climate and biodiversity crises, and designing appropriate policy responses.

Many estimates of abandonment are inferred from aggregated estimates of regional cultivation (e.g. from FAO data on cultivated area; [@Isbell2019; @Munroe2013]).
When derived from satellite imagery, estimates are most frequently calculated as the difference in cultivated area between two distinct points in time (e.g. 1992 and 2015 in [@Naess2021]).
Annual land cover time series are becoming more common, but recent uses for abandonment mapping have been limited to 2-12 years (e.g. [@Alcantara2013; @Estel2015; @Lark2015], but see @Dara2018).
...
Importantly, by masking dynamic patterns of abandonment and recultivation, these may result in significant overestimates of abandonment. 
...
Here, we utilize a new annual time-series of cropland abandonment [@Yin2020] derived from publicly available Landsat imagery (1987-2017) to investigate the duration and persistence of abandonment at eleven sites across four continents, including sites in Brazil (2), the US (2), Eastern Europe and Russia (4), the Middle East (1), and China (2) (Figure \@ref(fig:site-locations)).

Previous analyses have explored the age and persistence of secondary forests by identifying regeneration via the signal of woody regrowth in satellite imagery, though these have been constrained to the Neotropics [@Reid2018; @Nunes2020; @Smith2020] (though see also @Dara2018).
While well-suited to analyses of forest regrowth, this approach risks missing abandonment that is in earlier stages of regeneration or does not transition into woody vegetation, particularly in landscapes with non-forest habitats [@Yin2020].
Using a trajectory-based approach, @Yin2020 produced more accurate maps of cropland abandonment that did not rely on more easily detectable woody revegetation, which allow us to focus on abandonment itself, not only the regenerating forests that may or may not follow abandonment

These existing studies highlight the perils of short-lived secondary forests by providing estimates of the average persistence times of secondary forests, yet there continues to be relatively limited knowledge on the persistence and turnover of abandoned croplands.

<!-- Update this in the morning...  -->
...
Our study expands to a broader geographic coverage, and focuses on the implications of timing
...
In order to assess the effect of abandonment on biodiversity and carbon sequestration, we need a better understanding of how long agricultural abandonment lasts, how abandoned lands "decay," and which factors seem to predict the timing and decay.
...
- covers a longer and more detailed time period than other recent studies
...
We tracked groups (i.e. "cohorts") of croplands that were abandoned in a given year, modeling the proportion of each cohort remaining abandoned as a function of time elapsed since initial abandonment (see Section \@ref(methods), Figure \@ref(fig:abn-decay-s)).
...
The remaining sites showed trends that were not significantly different from zero, with recultivation neither speeding up nor slowing down over time.
...
Add plain language summary of the key results we found
- we observe lots of abandonment
- this abandonment is relatively short-lived in many of the sites
- There is a lot of variation across the sites
- many of the sites recultivation is speeding up
...
Most studies use a method that likely results in overly optimistic assessments of 

Placing results in the context of other recent studies of area and potential of abandonment (lean on recent Nature Sustainability paper).

Trillion Trees initiative, articles highlighting this reforestation – this may be transient benefit, not a permanent one. Complacency!

### Other research on the persistence of forests, timing of fallow periods in agriculture
...
## Implications for Biodiversity and Carbon benefits
...
### losses of farmland biodiversity & caveats
