...
2. Limit how much total area can be abandoned, based on the total amount of cropland at each site at the start of the time series. 
- The amount of abandoned cropland can never exceed the amount of cropland in 1987. 
