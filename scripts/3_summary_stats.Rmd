...
ggplot(data = vt, mapping = aes(x = fct_reorder(site, order), y = length)) +
  theme_classic() +
    ylab("Time abandoned (years)") + xlab("Site") +
  geom_violin(scale = "width", alpha = 0.5) +
  # geom_boxplot(width=0.2) + 
  # geom_jitter(height = 0.5, width = 0.2, alpha = 0.2) + 
...
# original plot, with the violin plots
...
ggsave(plot = gg_mean_length,
       filename = paste0(p_plots, run_label, "/mean_lengths", run_label, ".pdf"), 
