...
gg_mean_length_ridges <-
  ...
  theme_classic() +
  labs(y = "Proportion of abandonment periods of a given duration", # of a given duration
...
gg_mean_length_ridges_w_max <-
  ...
  scale_x_continuous(breaks = c(5, 10, 15, 20, 25, 30), expand = c(0, 0)) + 
  theme_classic() +
  labs(y = "Relative proportion of maximum abandonment \nlengths in each age class", 
       x = "Abandonment duration (years) ",
...
ggsave(plot = gg_mean_length_ridges_w_max + 
         theme(legend.spacing.x = unit(0.5, "mm"),
               legend.position = c(0.19, -0.18), legend.direction = "horizontal", 
               legend.box = "horizontal",
