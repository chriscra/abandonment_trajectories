...
total_crop_mask_files <- list.files(paste0(p_dat_derived, "total_crop_mask/old"), full.names = TRUE)
...
cellSize(ttt, unit = "ha", mask = TRUE) %>% global(., fun = "sum", na.rm = TRUE)
...
abn_2yr_mask <- rast(paste0(p_dat_derived, "abn_2yr/", site_df$site[i], "_abn_2yr_mask.tif"))
abn_cc_2017_mask <- rast(paste0(p_dat_derived, "abn_cc/", site_df$site[i], "_abn_cc_2017_mask.tif"))
