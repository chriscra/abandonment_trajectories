...
ggsave(plot = gg_mean_length_ridges,
       filename = paste0(p_plots, run_label, "/mean_lengths_w_ridges_hist", run_label, ".pdf"), 
...
# ---------------------------------------------------------------- #
# 4. Subtract the two (1987 - 2017), so that pixels that were cropland (1) in 1987, but not in 2017 (0) have a value of 1.
# Pixels that are cropland in both will be 0
