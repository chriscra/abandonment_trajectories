...
pnv_conus_aea <- project(x = pnv_conus, y = "+proj=aea +lat_0=23 +lon_0=-96 +lat_1=29.5 +lat_2=45.5 +x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs", filename = paste0(p_dat, "Habitats/PNV/pnv_conus_aea.tif"))

plot(pnv_conus_aea) # it worked!

# add the outline of CONUS
conus_aea <- st_transform(conus, crs(nlcd))
