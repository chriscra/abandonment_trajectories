...
pdf(file = paste0(p_output, "plots/age_aggregation_comparison.pdf"),
      width = 9, height = 3)
...
# ------------- raw abandonment age data ---------------- #
plot(s_age_r$y2017, main = "Shaanxi Age, 2017")

# ------------- aggregated with mean ---------------- #
plot(sa_agg_mean, main = "Aggregated with mean")

# ------------- aggregated with max ---------------- #
plot(sa_agg_max, main = "Aggregated with max")

# ------------- aggregated with median ---------------- #
plot(sa_agg_median, main = "Aggregated with median")
