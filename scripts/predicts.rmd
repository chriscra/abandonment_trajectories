...
```{r load-data}
predicts <- readRDS("/Users/christophercrawford/Google Drive/_Projects/data/Bd/PREDICTS/database.rds") # PREDICTS itself
# predicts_dt <- fread("/Users/christophercrawford/Google Drive/_Projects/data/Bd/PREDICTS/database.csv") # PREDICTS as a data.table
sites <- readRDS("/Users/christophercrawford/Google Drive/_Projects/data/Bd/PREDICTS/sites.rds") # Site-level summaries
columns <- read.csv("/Users/christophercrawford/Google Drive/_Projects/data/Bd/PREDICTS/columns.csv") # meta-data on variables, column names, etc.
references <- read.csv("/Users/christophercrawford/Google Drive/_Projects/data/Bd/PREDICTS/references.csv") # references
...
ecoregions_wwf <- st_read("/Users/christophercrawford/Google Drive/_Projects/data/Habitats/TEOW/wwf_terr_ecos.shp")

ecoregions <- st_read("/Users/christophercrawford/Google Drive/_Projects/data/Habitats/terr-ecoregions-TNC/tnc_terr_ecoregions.shp")
...
names(ecoregions)
levels(as.factor(ecoregions$ECO_NAME)) # 827 ecoregions. 
...
```{r g200-ecoregions}
g200 <- st_read("/Users/christophercrawford/Google Drive/_Projects/data/Habitats/global200ecoregions/g200_terr.shp")
