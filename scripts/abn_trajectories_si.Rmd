...
knitr::include_graphics(path = paste0(p_plots, run_label, "/decay/model_decay_curves_by_site_l3", run_label, ".png"))
```
...
knitr::include_graphics(path = paste0(p_plots, run_label, "/decay/time_to_range_l3", run_label, ".png"))
```
