...
(ref:caption-decay-curves-by-site) Average decay trajectories for each site, based on the mean coefficients across all cohorts of abandoned land.

```{r fig-decay-curves-by-site, fig.cap = '(ref:caption-decay-curves-by-site)', echo=FALSE}
...
(ref:caption-decay-time-to-range) Mean length of time abandoned (years) across our study sites. The mean abandonment length is calculated for only the maximum length for each pixel (blue) and across all periods of abandonment (a single pixel may go through multiple periods of abandonment).

```{r fig-decay-time-to-range, fig.cap = '(ref:caption-decay-time-to-range)', echo=FALSE}
# (ref:caption-decay-time-to-range) Sites included in this study, from @Yin2020.
# cite inline using the following  \@ref(fig:decay-time-to-range)
...
```{r fig-extrapolation-area-abn, fig.cap = '(ref:caption-extrapolation-area-abn)', echo=FALSE}
...
```{r fig-extrapolation-mean-age, fig.cap = '(ref:caption-extrapolation-mean-age)', echo=FALSE}
knitr::include_graphics(path = paste0(p_plots, run_label, "/decay/", 
...
```{r fig-extrapolation-area-by-age, fig.cap = '(ref:caption-extrapolation-area-by-age)', echo=FALSE}
knitr::include_graphics(path = paste0(p_plots, run_label, "/decay/", 
...
(ref:caption-decay-model-indiv-site-bh) Abandonment patterns for Bosnia & Herzegovina.
(ref:caption-decay-model-indiv-site-c) Abandonment patterns for Chongqing Province, China.
(ref:caption-decay-model-indiv-site-g) Abandonment patterns for Goiás, Brazil.
(ref:caption-decay-model-indiv-site-i) Abandonment patterns for Iraq.
(ref:caption-decay-model-indiv-site-mg) Abandonment patterns for Mato Grosso, Brazil.
(ref:caption-decay-model-indiv-site-n) Abandonment patterns for Nebraska, USA.
(ref:caption-decay-model-indiv-site-o) Abandonment patterns for Orenburg, Russia.
(ref:caption-decay-model-indiv-site-s) Abandonment patterns for Shaanxi/Shanxi Provinces, China.
(ref:caption-decay-model-indiv-site-v) Abandonment patterns for Volgograd, Russia.
(ref:caption-decay-model-indiv-site-w) Abandonment patterns for Wisconsin, USA.
