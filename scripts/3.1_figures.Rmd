...
# ------------- plot ---------------- #
cc_save_plot_lc_abn_area(input_df = area_s, subtitle = "Shaanxi/Shanxi Provinces, China", 
                         outfile_label = "s",
                         width = 6, height = 4)
...
# manual
persistence_count_long <- cc_calc_persistence(age_dt = s_age, land_cover_raster = s$y2017, 
                                              stat_proportion = FALSE,
                                              NA_first = FALSE)

persistence_count_long2 <- cc_calc_persistence(age_dt = s_age, land_cover_raster = s$y2017, 
                                              stat_proportion = FALSE, include_wide = TRUE,
                                              NA_first = FALSE)

# as a list

persistence_list_s <- cc_calc_persistence_all(age_dt = s_age, land_cover_raster = s$y2017)
...
cc_save_plot_area_gain_loss(input_df = abn_area_change_s, 
