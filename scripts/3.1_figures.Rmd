...
# generate plots
cc_save_plots_master(subtitle = "Shaanxi/Shanxi Provinces, China", outfile_label = "_s")

cc_save_plots_master(subtitle = "Shaanxi/Shanxi Provinces, China", input_site_label = "_s", 
                     outfile_label = "_s_all")

cc_save_plots_master(subtitle = "Eastern Belarus/Smolensk, Russia", input_site_label = "_b", 
...
abandonment_definition <- 5

abandoned_area_df <- tibble(
    year = 1987:2017,
    lc = "Abandoned",
    count = sapply(1:31, function(i) {s_age[get(paste0("y", 1987:2017)[i]) >= abandonment_definition, .N]}),
...
n_area_s <- bind_rows(filter(area_s, lc != "Abandoned"), abandoned_area_df) %>% print(n = 155)
